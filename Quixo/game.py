...
class Game(object):
    ...
    def play(self, player1: Player, player2: Player) -> int:
        ...
        while winner < 0:
            ...
            while not ok:
                ...
                it+=1
                if it>200:
                    print(f"{it} {from_pos} {slide}")
                #print(f"{from_pos}, {slide}, ok? {ok}")
            #self.print()
    ...
    def __move(self, from_pos: tuple[int, int], slide: Move, player_id: int) -> bool:
        ...
        if acceptable:
            ...
            if not acceptable:
                self.last_error="Error on slide"
    ...
    def __take(self, from_pos: tuple[int, int], player_id: int) -> bool:
        ...
        if not (self._board[from_pos] < 0 or self._board[from_pos] == player_id):
            self.last_error=f"Error on tile taken {self._board[from_pos]}"
        ...
        if not (
            ...
            self.last_error=f"Error on tile coords {from_pos}"
